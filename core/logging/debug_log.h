...
enum debug_log_msg_index_state_machine {
	...
	VERIFY_LOG_COMPONENT_RUN_AUTHEN_ACTIVE_SUCCESS,
	VERIFY_LOG_COMPONENT_RUN_AUTHEN_RECOVERY_SUCCESS,
	VERIFY_LOG_COMPONENT_RUN_AUTHEN_ACTIVE_FAIL,
	VERIFY_LOG_COMPONENT_RUN_AUTHEN_RECOVERY_FAIL,
	RECOVERY_LOG_COMPONENT_ENTRY_START,
	RECOVERY_LOG_COMPONENT_RUN_START,
	RECOVERY_LOG_COMPONENT_VERIFY_RECOVERY_SUCCESS,
	RECOVERY_LOG_COMPONENT_VERIFY_FAIL,
	UPDATE_LOG_COMPONENT_ENTRY_START,
	UPDATE_LOG_COMPONENT_RUN_START,
	UPDATE_LOG_COMPONENT_UPDATE_SUCCESS,
	UPDATE_LOG_COMPONENT_UPDATE_FAIL,
};
//State Machine log saving<

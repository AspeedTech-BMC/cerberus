...
#define MCTP_BASE_PROTOCOL_MSG_TYPE_SECURE				0x06
...
#define	MCTP_BASE_PROTOCOL_IS_SECURE_MSG(x)				(((x) & MCTP_BASE_PROTOCOL_MSG_TYPE_SET_MASK) == MCTP_BASE_PROTOCOL_MSG_TYPE_SECURE)

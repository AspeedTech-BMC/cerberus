...
#define MCTP_BASE_PROTOCOL_MSG_TYPE_SPDM_MSG				0x05
...
#define	MCTP_BASE_PROTOCOL_IS_SPDM_MSG(x)				(((x) & MCTP_BASE_PROTOCOL_MSG_TYPE_SET_MASK) == MCTP_BASE_PROTOCOL_MSG_TYPE_SPDM_MSG)
...
#define MCTP_BASE_PROTOCOL_MSG_TYPE_ECHO_TEST				0x7c
#define	MCTP_BASE_PROTOCOL_IS_ECHO_TEST_MSG(x)					(((x) & MCTP_BASE_PROTOCOL_MSG_TYPE_SET_MASK) == MCTP_BASE_PROTOCOL_MSG_TYPE_ECHO_TEST)
#endif
